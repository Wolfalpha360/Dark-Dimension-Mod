...
import dark.procedures.AcidMobplayerCollidesBlockProcedure;

import dark.DarkModElements;

@DarkModElements.ModElement.Tag
public class AcidBlock extends DarkModElements.ModElement {
	@ObjectHolder("dark:acid")
	public static final FlowingFluidBlock block = null;
	@ObjectHolder("dark:acid_bucket")
	public static final Item bucket = null;
	public static FlowingFluid flowing = null;
	public static FlowingFluid still = null;
	private ForgeFlowingFluid.Properties fluidproperties = null;
	public AcidBlock(DarkModElements instance) {
		super(instance, 6);
	...
	public void initElements() {
		fluidproperties = new ForgeFlowingFluid.Properties(() -> still, () -> flowing,
				FluidAttributes.builder(new ResourceLocation("dark:blocks/acidtexture"), new ResourceLocation("dark:blocks/acidtexture"))
