...
public class DarkstoneBlock extends DarkModElements.ModElement {
	@ObjectHolder("dark:darkstone")
	public static final Block block = null;
	public DarkstoneBlock(DarkModElements instance) {
		super(instance, 8);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			super(Block.Properties.create(Material.ROCK).sound(SoundType.STONE).hardnessAndResistance(1.6f, 18f).lightValue(0).harvestLevel(2)
	...
	public void init(FMLCommonSetupEvent event) {
		for (Biome biome : ForgeRegistries.BIOMES.getValues()) {
			...
			}.withConfiguration(new OreFeatureConfig(OreFeatureConfig.FillerBlockType.create("darkstone", "darkstone", blockAt -> {
			...
			}), block.getDefaultState(), 16)).withPlacement(Placement.COUNT_RANGE.configure(new CountRangeConfig(10, 0, 0, 120))));
		}
	}
}
