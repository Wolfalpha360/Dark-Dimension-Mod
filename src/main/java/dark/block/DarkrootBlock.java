...
public class DarkrootBlock extends DarkModElements.ModElement {
	@ObjectHolder("dark:darkroot")
	public static final Block block = null;
	public DarkrootBlock(DarkModElements instance) {
		super(instance, 21);
	}
