...
import dark.procedures.GlowshroomPlantDestroyedByPlayerProcedure;

import dark.DarkModElements;

@DarkModElements.ModElement.Tag
public class GlowshroomBlock extends DarkModElements.ModElement {
	@ObjectHolder("dark:glowshroom")
	public static final Block block = null;
	public GlowshroomBlock(DarkModElements instance) {
		super(instance, 84);
	}
	...
	public static class BlockCustomFlower extends FlowerBlock {
		...
		public boolean removedByPlayer(BlockState state, World world, BlockPos pos, PlayerEntity entity, boolean willHarvest, IFluidState fluid) {
			...
			int z = pos.getZ();
			{
				...
				GlowshroomPlantDestroyedByPlayerProcedure.executeProcedure($_dependencies);
			}
			return retval;
		}
	}
