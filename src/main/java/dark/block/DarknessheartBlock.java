...
import dark.item.HeartOfdarknessItem;

import dark.DarkModElements;

@DarkModElements.ModElement.Tag
public class DarknessheartBlock extends DarkModElements.ModElement {
	@ObjectHolder("dark:darknessheart")
	public static final Block block = null;
	public DarknessheartBlock(DarkModElements instance) {
		super(instance, 12);
	}
	...
	public static class BlockCustomFlower extends FlowerBlock {
		public BlockCustomFlower() {
			super(Effects.SATURATION, 0, Block.Properties.create(Material.PLANTS).doesNotBlockMovement().sound(SoundType.GROUND)
					.hardnessAndResistance(0.2f, 0f).lightValue(0));
			setRegistryName("darknessheart");
		}
		...
		public void addInformation(ItemStack itemstack, IBlockReader world, List<ITextComponent> list, ITooltipFlag flag) {
			...
			list.add(new StringTextComponent("A heart of pure darkness"));
		}
		...
		public List<ItemStack> getDrops(BlockState state, LootContext.Builder builder) {
			...
			return Collections.singletonList(new ItemStack(HeartOfdarknessItem.block, (int) (1)));
		}
