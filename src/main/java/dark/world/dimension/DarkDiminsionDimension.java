...
import dark.item.DarkDiminsionItem;

import dark.block.DarkstoneBlock;
import dark.block.AcidBlock;
...
public class DarkDiminsionDimension extends DarkModElements.ModElement {
	@ObjectHolder("dark:dark_diminsion")
	public static final ModDimension dimension = null;
	@ObjectHolder("dark:dark_diminsion_portal")
	public static final CustomPortalBlock portal = null;
	public static DimensionType type = null;
	private static Biome[] dimensionBiomes;
	public DarkDiminsionDimension(DarkModElements instance) {
		super(instance, 7);
	...
	public void registerDimension(RegistryEvent.Register<ModDimension> event) {
		event.getRegistry().register(new CustomModDimension().setRegistryName("dark_diminsion"));
	}

	@SubscribeEvent
	public void onRegisterDimensionsEvent(RegisterDimensionsEvent event) {
		if (DimensionType.byName(new ResourceLocation("dark:dark_diminsion")) == null) {
			DimensionManager.registerDimension(new ResourceLocation("dark:dark_diminsion"), dimension, null, false);
		}
		type = DimensionType.byName(new ResourceLocation("dark:dark_diminsion"));
	}

	@Override
	public void init(FMLCommonSetupEvent event) {
		dimensionBiomes = new Biome[]{ForgeRegistries.BIOMES.getValue(new ResourceLocation("dark:darkland")),
				ForgeRegistries.BIOMES.getValue(new ResourceLocation("dark:barrenlands")),};
	}

	@Override
	public void initElements() {
		elements.blocks.add(() -> new CustomPortalBlock());
		elements.items.add(() -> new DarkDiminsionItem().setRegistryName("dark_diminsion"));
	}
	...
	public static class CustomPortalBlock extends NetherPortalBlock {
		public CustomPortalBlock() {
			...
			setRegistryName("dark_diminsion_portal");
		}
		...
		private TeleporterDimensionMod getTeleporterForDimension(Entity entity, BlockPos pos, ServerWorld nextWorld) {
			BlockPattern.PatternHelper bph = DarkDiminsionDimension.CustomPortalBlock.createPatternHelper(entity.world, pos);
	...
	public static final TicketType<BlockPos> CUSTOM_PORTAL = TicketType.create("dark_diminsion_portal", Vec3i::compareTo, 300);
	@SubscribeEvent
	public void registerPointOfInterest(RegistryEvent.Register<PointOfInterestType> event) {
		try {
			...
			poi = (PointOfInterestType) method.invoke(null, "dark_diminsion_portal",
	...
	public static class TeleporterDimensionMod implements ITeleporter {
		...
		public BlockPattern.PortalInfo placeInExistingPortal(BlockPos p_222272_1_, Vec3d p_222272_2_, Direction directionIn, double p_222272_4_,
			...
			return optional.map((p_226707_7_) -> {
				...
				BlockPattern.PatternHelper blockpattern$patternhelper = DarkDiminsionDimension.CustomPortalBlock.createPatternHelper(this.world,
						blockpos);
		...
		public ChunkProviderModded(IWorld world, BiomeProvider provider) {
			super(world, provider, new OverworldGenSettings() {
				...
				public BlockState getDefaultFluid() {
					return AcidBlock.block.getDefaultState();
				}
			});
